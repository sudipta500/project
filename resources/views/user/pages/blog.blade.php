    ...
    {{-- <nav class="navbar navbar-expand-lg navbar-top  bg-white">
        <div class="container"><a class="navbar-brand" href="index.html"><svg xmlns="http://www.w3.org/2000/svg" width="124" height="30" fill="none" class="dark">
            ...
            <ul class="nav navbar-nav order-2 ms-auto nav-no-opacity">
                <li class="nav-item navbar-dropdown active" style="cursor: pointer"><p class="nav-link"><span>Home</span></p>
                </li>
                <li class="nav-item navbar-dropdown" style="cursor: pointer"><p class="nav-link" ><span>Services</span></p>
                </li>
                <li class="nav-item navbar-dropdown" style="cursor: pointer"><p class="nav-link" ><span>Programming Blog</span></p>
                </li>
        ...
        <div class="container">
            ...
            <div class="isotope">
                <ul class="nav justify-content-center isotope-filters mb-60">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#" data-filter="architecture">Architecture</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <nav id="sidebar" class="sidebar js-sidebar">
                        <div class="sidebar-content js-simplebar">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="sidebar-item active dropdown">
                                    <a class="sidebar-link dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
